...
public class UserActivity extends AppCompatActivity {
    ...
    private ImageView image_view_menu_item;
    ...
    private void initView() {
        ...
        this.image_view_menu_item=(ImageView) findViewById(R.id.image_view_menu_item);
    ...
    private void initAction() {
        this.image_view_menu_item.setOnClickListener(v->{
